    ...
    try:
        ...
        # Handle button/list click
            ...
            if interactive.get('type') == 'button_reply':
                ...
                if btn_id == 'menu':
                    # Show main categories list
                    sections = [{
                        'title': 'Categories',
                        'rows': [{'id': cat['id'], 'title': cat['title']} for cat in MAIN_CATEGORIES]
                    }]
                ...
                if list_id in [c['id'] for c in MAIN_CATEGORIES]:
                    if list_id in SUB_CATEGORIES:
                        ...
                        sections = [{
                            ...
                            'rows': [{'id': sub['id'], 'title': sub['title']} for sub in SUB_CATEGORIES[list_id]]
                        }]
...
if __name__ == '__main__':
    ...
    logger.info("A Jewel Studio WhatsApp Bot - Menu System")
